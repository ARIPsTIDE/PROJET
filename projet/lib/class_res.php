...
public function resUpdate($id, $data){
    ...
    if($$commentaire == "" OR $moderation == "" OR $annul_resa ==  "" OR $id_client ==  "" OR $id_bien ==  ""){
    ...
    $query = "UPDATE reservations SET commentaire=:commentaire, moderation=:moderation, annul_resa=:annul_resa, id_client=:id_client, id_bien=:id_bien WHERE id_reservation = :id";
    $sql = $this->db->pdo->prepare($query);
