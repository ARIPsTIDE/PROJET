...
if($userdata){
    foreach($userdata as $data){ ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control" value="<?php echo $data['user_first_name'] ?>" id="name">
                </div>
                <div class="form-group">
                    <label for="username">Username</label>
                    <input type="text" name="username" class="form-control" value="<?php echo $data['user_last_name'] ?>" id="username">
                </div>
                <div class="form-group">
