...
class user{
    ...
    public function userRegistration($data){
        ...
        $query = "INSERT INTO users (user_first_name, user_last_name, user_email, user_password) VALUES (:name, :username, :email, :password)";
    ...
    public function getLoginUserData($name, $password){
        $query = "SELECT * FROM users WHERE user_first_name = :name AND user_password = :password ";
        $sql = $this->db->pdo->prepare($query);
    ...
    public function userUpdate($id, $data){
        ...
        //insert data if there is no error            
        $query = "UPDATE users SET user_first_name=:name, user_last_name=:username, user_email=:email, user_password=:password WHERE user_id = :id";
        $sql = $this->db->pdo->prepare($query);
        $sql->bindValue(':name', $name);
        $sql->bindValue(':username', $username);
        $sql->bindValue(':email', $email);
